...
int main()
{
        ...
        CreateSem(&w_sem,0);
        start_thread(reader);
        printf("Welcome Reader 1 (Reader1 created)\n");
        printf("Welcome Reader 2 (Reader2 created)\n");
        start_thread(reader);
        printf("Welcome Reader 3 (Reader3 created)\n");
        start_thread(reader);
        printf("Welcome Writer 1 (Writer1 created)\n");
        start_thread(writer);
        printf("Welcome Writer 2 (Writer2 created)\n");
        start_thread(writer);
